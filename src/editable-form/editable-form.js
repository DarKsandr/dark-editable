...
export const template = `<form class="form-inline editableform">
...
export const loading = '<div class="editableform-loading"></div>';

export const buttons = `<button type="submit" class="editable-submit">ok</button><button type="button" class="editable-cancel">cancel</button>`;

const errorGroupClass = null;

//error class attached to editable-error-block
const errorBlockClass = 'editable-error';